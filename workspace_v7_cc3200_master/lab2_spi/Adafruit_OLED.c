...
*/
    ...
    // Set DC pin to low (command)
    GPIOPinWrite(GPIOA1_BASE, 0x2, 0x0);

    // CS is low
    GPIOPinWrite(GPIOA2_BASE, 0x2, 0x0);
    MAP_SPICSEnable(GPIOA2_BASE);

    unsigned char dummy;
    MAP_SPIDataPut(GPIOA2_BASE,c);
    MAP_SPIDataGet(GPIOA2_BASE,&dummy);

    GPIOPinWrite(GPIOA2_BASE, 0x2, 0x2);
    MAP_SPICSDisable(GPIOA2_BASE);
}
//*****************************************************************************
